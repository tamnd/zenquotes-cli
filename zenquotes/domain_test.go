...
func TestHostWiring(t *testing.T) {
	...
	if want := "zenquotes://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("zenquotes", "about")
	if err != nil || got.String() != "zenquotes://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want zenquotes://page/about", got.String(), err)
	}
}
