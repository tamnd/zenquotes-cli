...
```
zenquotes <command> [arguments] [flags]
```

Run `zenquotes <command> --help` for the full flag list on any command. This
...
per operation you declare in `zenquotes/domain.go`.
