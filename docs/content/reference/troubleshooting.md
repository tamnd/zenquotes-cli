...
Most of these come down to network reality or how zenquotes serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

zenquotes rate-limits like any public site. zenquotes already paces
...
Where a surface is gated, zenquotes reads a cookie or token you supply
...
`zenquotes`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what zenquotes actually did
